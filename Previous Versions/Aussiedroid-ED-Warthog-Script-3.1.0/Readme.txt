...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------//
// VERSION HISTORY //		Version 3.1.0		\\ Released Sept 2016	|	Updated Apr 2018 //	\\		Public Release #17		//
// =============================================================================================================================================================//
...
// v3.0.1-BETA UPDATE: Added the new Galnet Audio keybindings mapped in ED .binds file which are now updated to (v3.0).						//
...
The Warthog Script can be run from any location. All files need to be in the same folder though. Profile files are found in the '/Warthog Script' folder.
Run/Compile via AD_ED_vx.x.x.tmc. 

...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------//
// Version 2.4.1																		//
// Released September, 2016	(Updated Jul 17)														//	
// =============================================================================================================================================================//
...
The Warthog Script can be run from any location. All files need to be in the same folder though. Profile files are found in the '/Warthog Script' folder. Run/Compile via AD_EliteDangerous_v2.x.x.tmc. 
